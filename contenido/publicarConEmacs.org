...
Con esto se pueden establecer parámetros como el tamaño o el título de la imagen, pero también se puede definir cualquier parámetro como de html como se ve al final de la línea =#+attr_html= del ejemplo anterior.
